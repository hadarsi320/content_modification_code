...
def run_2of2_competition(logger, options):
    # setting variables
...
def run_2of5_competition(logger, options):
    # setting variables
    qid = options.qid
...
if __name__ == '__main__':
    ...
    parser.add_option('--competition_type', choices=['2of2', '2of5'])
    ...
    if options.competition_type == '2of2':
        run_2of2_competition(logger, options)
    else:
        run_2of5_competition(logger, options)
